...
// 4) ссылки в шапке страницы (чтобы они были /phuket/... или /pattaya/...
...
const selected = ref(new Set(['Виллы']))

// ВАЖНО: правильное написание!
const chips = ['Виллы', 'Апартаменты', 'Новинки рынка']
...
<template>
    <div class="relative bg-img  flex items-end" :class="currentCity">
        <div class="container w-full z-10">
            <div class="hero flex flex-col lg:flex-row justify-between items-start w-full mb-20" data-aos="fade-up"
                ...
                <div class="text-left text-white">
                    <h1 class="text-xl lg:text-4xl light">Купить виллу<br></br> <span
                            class="text-4xl lg:text-6xl uppercase bl">
                            {{ currentCity === 'phuket' ? 'на Пхукете' :
                                'в Паттайе' }}</span>
                    </h1>
        ...
        <!-- <img src="/img/palm.webp" alt="фон" class="absolute" data-aos="fade-right" data-aos-delay="200"
    ...
    <div class="container mx-auto my-12 lg:my-28  bg-white p-6 lg:p-10  rounded-[30px]">
        <div class="flex flex-col lg:flex-row justify-between items-start ">
            <h2 class="light text-2xl lg:text-4xl  lg:mb-10 w-full lg:w-1/2">
                <span class="bl0"> Каталог вилл </span><br></br>
                {{ currentCity === 'phuket' ? 'на Пхукете' :
                    'в Паттайе' }}
            </h2>
            <p class="block w-full lg:w-1/2 my-4 lg:my-0">
                Покупа Недвижимости здесь — это не просто дом у моря, а выгодное вложение.
            </p>
        </div>
        <!-- 
        <div>
...
/* .bg-img {
    background-image: url('/img/v-bg.webp');
...
.bg-img.pattaya::before {
    background-image: url('/img/v-bg2.webp');
}
