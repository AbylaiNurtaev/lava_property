         ...
         lg:flex lg:flex-col">
            <div class="lg:overflow-y-auto lg:min-h-0">
                ...
                <div class="flex mb-2">
                    ...
                    <img class="-ml-4" src="/img/people/sergio.png" alt="Менеджер" />
                    <img class="-ml-6" src="/img/people/vika.png" alt="Менеджер" />
                    <img class="-ml-6" src="/img/people/ekat.png" alt="Менеджер" />
                </div>
                <p>
                ...
                <div class="flex items-center gap-6">
                    <p class="w-[400px] text-[10px] lg:text-base">
