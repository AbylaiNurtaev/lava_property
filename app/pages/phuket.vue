...
<template>
    ...
    shadow-[0_8px_32px_rgba(0,0,0,0.2)]">
                            ...
                            <div class="flex flex-col w-1/2 ">
                                <div class="text-4xl">25%</div>
                                <p class="text-sm leading-[15px]">Рост до</p>
                            </div>
                        </div>
    ...
    shadow-[0_8px_32px_rgba(0,0,0,0.2)] p-4 ">
                    ...
                    <!-- <p class="my-2"> Доход 8-12%, рост до 25%, полное спровождение</p> -->
                </div>
    ...
    <TheChoouse />
    <TheReviews />
    <PageRating class="container my-10 lg:my-36" page="/phuket" page-title="Страница города: Пхукет" />
</template>
...
.bg-img.phuket::before {
    background-image: url('/img/bg-phuket2.webp');
    /* поставь нужный файл */
}
